...
function Hero() {
  return (
    <main className="grid grid-cols-2 px-14 py-20">
      <div className="h-full font-Inter text-white flex flex-col items-center justify-center">
        <div className="font-thin pb-8">
          <h1 className="text-5xl leading-[58px]">
            Hey, I’m<span className="ml-4 font-medium">Prajna R Patil.</span>
          </h1>
